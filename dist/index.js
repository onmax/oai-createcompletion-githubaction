...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const max_tokens = parseInt(core.getInput('max_tokens'));
            const temperature = parseFloat(core.getInput('temperature'));
            const prompt = core.getInput('prompt');
            const apiKey = core.getInput('openai_api_key');
            const organization = core.getInput('openai_org_id');
            const res = yield (0, openai_1.getResponse)({
...
function checkParam(param, value) {
    if (param === '') {
        throw new Error(`No ${param} provided. Please provide a ${param}. Current ${param}: ${value}`);
    }
}
function getResponse({ modelConf, apiConf }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const configuration = new openai_1.Configuration({ organization, apiKey });
...
const packageJson = __nccwpck_require__(1416);
class Configuration {
    constructor(param = {}) {
        ...
        if (!this.formDataCtor) {
            this.formDataCtor = __nccwpck_require__(7993);
        }
    }
    /**
...
var populate = __nccwpck_require__(1776);
